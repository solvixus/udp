...
class EasyUDPSocket {
  ...
  static Future<EasyUDPSocket> bindSimple(int port,
      [bool reusePort = false]) async {
  ...
  static Future<EasyUDPSocket> bindMulticast(String ip, int port,
      [bool reusePort = false]) async {
    RawDatagramSocket socket = await RawDatagramSocket.bind(
        InternetAddress.anyIPv4, port,
        reusePort: reusePort);
  ...
  static Future<EasyUDPSocket> bindBroadcast(int port,
      [bool reusePort = false]) async {
    RawDatagramSocket socket = await RawDatagramSocket.bind(
        InternetAddress.anyIPv4, port,
        reusePort: reusePort);
